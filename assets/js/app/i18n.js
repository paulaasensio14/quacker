...
(function () {
  ...
  const messages = {
    es: {
      ...
      home_challenge_settings_title: "Configurar reto mensual",
      home_challenge_settings_text: "Define cuántos contenidos quieres completar este mes y la recompensa que te motivará a conseguirlo.",
      home_challenge_settings_target_label: "Objetivo del mes",
      home_challenge_settings_reward_label: "Recompensa",
      home_challenge_settings_reward_placeholder: "Ej: Insignia de maratón",
      home_challenge_settings_save: "Guardar reto",
      home_challenge_settings_reset: "Restablecer",
      home_challenge_settings_saved_title: "Reto actualizado",
      home_challenge_settings_saved_text: "Tu reto mensual ya está configurado.",
      home_challenge_settings_reset_title: "Reto restablecido",
      home_challenge_settings_reset_text: "Has vuelto al reto mensual por defecto.",
      home_challenge_settings_target_error: "Elige un objetivo válido para este mes.",
      home_challenge_settings_reward_error: "Añade una recompensa breve para guardar el reto.",
      home_challenge_custom_description_single: "Completa 1 contenido este mes.",
      home_challenge_custom_description_plural: "Completa {{count}} contenidos este mes.",
    ...
    en: {
      ...
      home_challenge_settings_title: "Configure monthly challenge",
      home_challenge_settings_text: "Choose how many items you want to complete this month and the reward that will keep you motivated.",
      home_challenge_settings_target_label: "Monthly target",
      home_challenge_settings_reward_label: "Reward",
      home_challenge_settings_reward_placeholder: "Ex: Marathon badge",
      home_challenge_settings_save: "Save challenge",
      home_challenge_settings_reset: "Reset",
      home_challenge_settings_saved_title: "Challenge updated",
      home_challenge_settings_saved_text: "Your monthly challenge is now configured.",
      home_challenge_settings_reset_title: "Challenge reset",
      home_challenge_settings_reset_text: "You are back to the default monthly challenge.",
      home_challenge_settings_target_error: "Choose a valid target for this month.",
      home_challenge_settings_reward_error: "Add a short reward name to save the challenge.",
      home_challenge_custom_description_single: "Complete 1 item this month.",
      home_challenge_custom_description_plural: "Complete {{count}} items this month.",
